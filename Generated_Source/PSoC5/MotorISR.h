...
#define MotorISR_INTC_VECTOR            ((reg32 *) MotorISR__INTC_VECT)
...
#define MotorISR_INTC_SET_EN            ((reg32 *) MotorISR__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the MotorISR interrupt. */
#define MotorISR_INTC_CLR_EN            ((reg32 *) MotorISR__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the MotorISR interrupt state to pending. */
#define MotorISR_INTC_SET_PD            ((reg32 *) MotorISR__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the MotorISR interrupt. */
#define MotorISR_INTC_CLR_PD            ((reg32 *) MotorISR__INTC_CLR_PD_REG)
