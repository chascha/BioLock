...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void Motor_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & Motor_1_INTR) != 0u) 
		{ 
			 Motor_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Motor_2_INTR) != 0u) 
		{ 
			 Motor_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Motor_3_INTR) != 0u) 
		{ 
			 Motor_3_INTTYPE_REG = (uint8)mode; 
		}
    }
