// ======================================================================
// BioLock.v generated from TopDesign.cysch
// 04/27/2021 at 18:57
...
module top ;
	...
	wire [0:0] tmpOE__Cycle_net;
	wire [0:0] tmpIO_0__Cycle_net;
	wire [0:0] tmpINTERRUPT_0__Cycle_net;
	electrical [0:0] tmpSIOVREF__Cycle_net;
	...
	cy_psoc3_pins_v1_10
		...
		Cycle
		 (.oe(tmpOE__Cycle_net),
		  .y({1'b0}),
		  .fb({Net_71}),
		  .io({tmpIO_0__Cycle_net[0:0]}),
		  .siovref(tmpSIOVREF__Cycle_net),
		  .interrupt({tmpINTERRUPT_0__Cycle_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cycle_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Confirm_net;
	wire [0:0] tmpIO_0__Confirm_net;
	wire [0:0] tmpINTERRUPT_0__Confirm_net;
	electrical [0:0] tmpSIOVREF__Confirm_net;

	cy_psoc3_pins_v1_10
		#(.id("27b7b5c1-d2e8-40f3-ae9e-2e4e7784ff1e"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Confirm
		 (.oe(tmpOE__Confirm_net),
		  .y({1'b0}),
		  .fb({Net_78}),
		  .io({tmpIO_0__Confirm_net[0:0]}),
		  .siovref(tmpSIOVREF__Confirm_net),
		  .interrupt({tmpINTERRUPT_0__Confirm_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Confirm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Overwrite_net;
	wire [0:0] tmpIO_0__Overwrite_net;
	wire [0:0] tmpINTERRUPT_0__Overwrite_net;
	electrical [0:0] tmpSIOVREF__Overwrite_net;

	cy_psoc3_pins_v1_10
		#(.id("f19d679b-d1a5-4654-b71f-fe82a3d41122"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Overwrite
		 (.oe(tmpOE__Overwrite_net),
		  .y({1'b0}),
		  .fb({Net_84}),
		  .io({tmpIO_0__Overwrite_net[0:0]}),
		  .siovref(tmpSIOVREF__Overwrite_net),
		  .interrupt({tmpINTERRUPT_0__Overwrite_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Overwrite_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("29b7c6de-bd5e-48b9-907d-cfa1c5ac718a"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ae98a68c-0e06-4cf5-90cf-e977f8273f94"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ICPCK_net;
	wire [0:0] tmpIO_0__ICPCK_net;
	wire [0:0] tmpINTERRUPT_0__ICPCK_net;
	electrical [0:0] tmpSIOVREF__ICPCK_net;

	cy_psoc3_pins_v1_10
		#(.id("a2af4bd9-e269-4d9e-a3a1-5e3ecf721176"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ICPCK
		 (.oe(tmpOE__ICPCK_net),
		  .y({1'b0}),
		  .fb({Net_172}),
		  .io({tmpIO_0__ICPCK_net[0:0]}),
		  .siovref(tmpSIOVREF__ICPCK_net),
		  .interrupt({tmpINTERRUPT_0__ICPCK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ICPCK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [3:0] tmpOE__Motor_net;
	wire [3:0] tmpFB_3__Motor_net;
	wire [3:0] tmpIO_3__Motor_net;
	...
	cy_psoc3_pins_v1_10
		...
		Motor
		 (.oe(tmpOE__Motor_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Motor_net[3:0]}),
		  .io({tmpIO_3__Motor_net[3:0]}),
	...
	assign tmpOE__Motor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
    ...
    Timer_v2_80_2 MotorTimer (
        ...
        .tc(Net_63),
        .clock(Net_10));
    defparam MotorTimer.CaptureCount = 2;
    defparam MotorTimer.CaptureCounterEnabled = 0;
    defparam MotorTimer.DeviceFamily = "PSoC5";
    defparam MotorTimer.InterruptOnCapture = 0;
    defparam MotorTimer.InterruptOnTC = 1;
    defparam MotorTimer.Resolution = 8;
    defparam MotorTimer.SiliconRevision = "0";
	...
	cy_psoc3_pins_v1_10
		#(.id("885c2a45-53e4-43f7-a3ef-e1b906cd8d2d"),
    ...
    Debouncer_v1_0 CycleDebounce (
        ...
        .either(Net_75),
        .pos(Net_76));
    defparam CycleDebounce.EitherEdgeDetect = 0;
    defparam CycleDebounce.NegEdgeDetect = 0;
    defparam CycleDebounce.PosEdgeDetect = 1;
    defparam CycleDebounce.SignalWidth = 1;

    Debouncer_v1_0 ConfirmDebounce (
        .d(Net_78),
        .clock(Net_103),
        .q(Net_82),
        .neg(Net_80),
        .either(Net_79),
        .pos(Net_81));
    defparam ConfirmDebounce.EitherEdgeDetect = 0;
    defparam ConfirmDebounce.NegEdgeDetect = 0;
    defparam ConfirmDebounce.PosEdgeDetect = 1;
    defparam ConfirmDebounce.SignalWidth = 1;

    Debouncer_v1_0 OverwriteDebounce (
        .d(Net_84),
        .clock(Net_103),
        .q(Net_88),
        .neg(Net_86),
        .either(Net_85),
        .pos(Net_87));
    defparam OverwriteDebounce.EitherEdgeDetect = 0;
    defparam OverwriteDebounce.NegEdgeDetect = 0;
    defparam OverwriteDebounce.PosEdgeDetect = 1;
    defparam OverwriteDebounce.SignalWidth = 1;

    Debouncer_v1_0 ForwardDebounce (
        .d(Net_90),
        .clock(Net_103),
        .q(Net_94),
        .neg(Net_92),
        .either(Net_91),
        .pos(Net_93));
    defparam ForwardDebounce.EitherEdgeDetect = 0;
    defparam ForwardDebounce.NegEdgeDetect = 0;
    defparam ForwardDebounce.PosEdgeDetect = 1;
    defparam ForwardDebounce.SignalWidth = 1;

    Debouncer_v1_0 BackDebounce (
        .d(Net_96),
        .clock(Net_103),
        .q(Net_100),
        .neg(Net_98),
        .either(Net_97),
        .pos(Net_99));
    defparam BackDebounce.EitherEdgeDetect = 0;
    defparam BackDebounce.NegEdgeDetect = 0;
    defparam BackDebounce.PosEdgeDetect = 1;
    defparam BackDebounce.SignalWidth = 1;


	cy_clock_v1_0
		#(.id("27a170f2-05d9-413c-82bc-ac554c66923a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("5000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Solenoid_net;
	wire [0:0] tmpFB_0__Solenoid_net;
	wire [0:0] tmpIO_0__Solenoid_net;
	wire [0:0] tmpINTERRUPT_0__Solenoid_net;
	electrical [0:0] tmpSIOVREF__Solenoid_net;

	cy_psoc3_pins_v1_10
		#(.id("606fb9d4-7b6b-4325-816f-396465ef89dc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Solenoid
		 (.oe(tmpOE__Solenoid_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Solenoid_net[0:0]}),
		  .io({tmpIO_0__Solenoid_net[0:0]}),
		  .siovref(tmpSIOVREF__Solenoid_net),
		  .interrupt({tmpINTERRUPT_0__Solenoid_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Solenoid_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Debouncer_v1_0 ICPCKDebounce (
        .d(Net_172),
        .clock(Net_103),
        .q(Net_174),
        .neg(Net_175),
        .either(Net_176),
        .pos(Net_177));
    defparam ICPCKDebounce.EitherEdgeDetect = 0;
    defparam ICPCKDebounce.NegEdgeDetect = 0;
    defparam ICPCKDebounce.PosEdgeDetect = 1;
    defparam ICPCKDebounce.SignalWidth = 1;
